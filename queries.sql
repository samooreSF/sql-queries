...
SELECT * FROM invoices ORDER BY orders;
...
SELECT * FROM invoices WHERE invoice_date < '2010-01-01' ORDER BY invoice_date DESC limit 10;
...
SELECT billing_country, COUNT(*), SUM(total) FROM invoices GROUP BY billing_country ORDER BY COUNT(*)/SUM(total) DESC LIMIT 5;
